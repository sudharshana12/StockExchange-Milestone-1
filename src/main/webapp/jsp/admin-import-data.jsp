...
<body>
    ...
    <div class="page-body">
            ...
            <label class="page-label">Select Excel file to be uploaded</label>
            <input type="file" name="file-input-box" id="file-input-box" value="Upload">
            <div class="page-link-div"> <a href="#"  class="import-page-link">Click Here to download sample Excel file</a></div>
